...
class TerrainShadowRenderPhase : public star::core::renderer::RenderPhase
{
  ...
  protected:
    ...
    using OwningBarrierFunction = void (*)(uint8_t, const uint64_t &, const star::core::renderer::FrameData *,
                                           const DataRoles *, const star::core::renderer::RenderingContext *,
  ...
  private:
    ...
    static void AddOwnsCameraBarrier(uint8_t frameInFlightIndex, const uint64_t &frameIndex,
